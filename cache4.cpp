...
Cache design_level_cache(int cache_size,int block_size,int assosciativity){
    ...
    int a = cache_size/assosciativity;  // based on our type of input
...
int main(){
  ...
  /*  int cache_size = 8;
    ...
    int cache_size11;
    int block_size11;
    int assosciativity11;
    int cache_size_22;
    int block_size_22;
    int assosciativity_22;
    cout<<"enter cache size for level1"<<endl;
    cin>>cache_size11;
    cout<<"enter block size for level1"<<endl;
    cin>>block_size11;
    cout<<"enter assosciativity for level1"<<endl;
    cin>>assosciativity11;
    cout<<"enter cache size for level2"<<endl;
    cin>>cache_size_22;
    cout<<"enter block size for level2"<<endl;
    cin>>block_size_22;
    cout<<"enter assosciativity for level2"<<endl;
    cin>>assosciativity_22;
    int cache_size = cache_size11/block_size11;
    int cache_size_2 = cache_size_22/block_size_22;
    int block_size = block_size11/4;
    int block_size_2 = block_size_22/4;
    Cache level1 = design_level_cache(cache_size,block_size,assosciativity11);
    Cache level2 = design_level_cache(cache_size_2,block_size_2,assosciativity_22);
    int cache_latency1;
    int cache_latency2;
